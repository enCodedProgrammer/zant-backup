...
export default function DeactivateModal({ onClickEvent }: { onClickEvent: Function }) {
    return (
        <dialog id="deactivate_modal" className="modal">
                ...
                <div className="px-20 py-10 flex flex-col gap-8 items-center">
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <h4 className="text-center text-heading-2xs">
                            Are you sure you want to deactivate these users account?
                        </h4>
